...
// [pinvou3-fork] 原 pinvou3 P0-1 的 `render_available_skills_context_for_workspace_and_dir`
// union 实现已被上游 v0.8.57 harvest(见下方同名「Union variant」),删此重复定义取上游版。
// 注:pinvou3 的 #41「skills 扫描路径只留 ~/.agents/skills」收窄在 skills_directories,与此无关。
