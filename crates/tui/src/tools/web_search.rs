...
mod tests {
    use super::{
        ...
        bocha_error_message, decode_html_entities, extract_search_query, is_likely_spam_results,
        normalize_bing_url, optional_search_max_results, parse_baidu_results, parse_bocha_results,
