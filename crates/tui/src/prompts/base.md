...
- **File I/O**: `read_file` (PDFs auto-extracted), `list_dir`, `write_file`, `append_file`, `edit_file`, `apply_patch`, `retrieve_tool_result` for prior spilled large tool outputs.
